...
from clubpromoters.models import User, Code, Party, Purchase, Ticket, File, Refund, activation_code
from clubpromoters.values import ACCESS, ORGANIZER, PROMOTER, CLUB_OWNER, HOSTESS, ADMIN, NORMAL, STATUS_PAID, \
    STATUS_CANCELED, UPLOAD_FOLDER, PLACEHOLDER_URL
